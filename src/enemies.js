...
//2-2
    ...
    enemy_templates["探险者的怨恨"] = new Enemy({
        name: "Explorer's Resentment",
        description: "Time-Seal? Its HP is way too thin… can it really survive until the second attack?", 
        xp_value: 102334155, 
        rank: 3401,
    ...
    enemy_templates["出芽橙茸战士"] = new Enemy({
        name: "Budding Orange Mushroom Warrior",
        description: "Rainbow Attack (2/7)!! Budding alone and holding a weapon alone are both useless — but combined... it looks like a destined spirit treasure!", 
        xp_value: 102334155, 
        rank: 3402,
    ...
    enemy_templates["敌意猎兵"] = new Enemy({
        name: "Hostile Hunter",
        description: "Apart from having much less HP, it's basically the same as the one before. The six that mobbed you earlier were already elite units…", 
        xp_value: 102334155, 
        rank: 3403,
    ...
    enemy_templates["大眼霜冻鱼"] = new Enemy({
        ...
        description: "Sadly, because the temperature is so low and ice energy overflows everywhere, there's no lake to fish in here… the living fish all crawled out!", 
        xp_value: 102334155, 
        rank: 3404,
    ...
    enemy_templates["敌意女巫"] = new Enemy({
        name: "Hostile Witch",
        description: "So it's this one… not only is the halo strong, it can stack too! That's really too much!", 
        xp_value: 165580141, 
        rank: 3405,
    ...
    enemy_templates["出芽黄茸战士"] = new Enemy({
        name: "Budding Yellow Mushroom Warrior",
        description: "Rainbow Attack (3/7)! How can any special ability compare to a well-trained… mushroom body?", 
        xp_value: 165580141, 
        rank: 3406,
    ...
    enemy_templates["绝对低温能源"] = new Enemy({
        ...
        description: "Not only is its own temperature near 0K, it also contains a lethal dose of ice energy. One of these can neutralize dozens of [Nuclear Explosion Energy Sources]!", 
        xp_value: 165580141, 
        rank: 3407,
    ...
    enemy_templates["敌意骑士"] = new Enemy({
        name: "Hostile Knight",
        description: "Long, long ago, there was a similar-looking monster in the [Yangang City] area... I remember during the first commit, there was a gap in the middle, but anyway — せーの！っインターネット最高！", 
        xp_value: 165580141, 
        rank: 3408,
    ...
    enemy_templates["出芽绿茸战士"] = new Enemy({
        name: "Budding Green Mushroom Warrior",
        description: "Rainbow Attack (4/7)! It's only slightly stronger than the last one…", 
        xp_value: 165580141, 
        rank: 3409,
    ...
    enemy_templates["冰血除草者"] = new Enemy({
        name: "Ice-Blood Weeder",
        description: "A thrilling combo — 108 billion (crossed out) 48 billion kill threshold! Though due to RPG mechanics, the ice-freeze and holy array combo is gone anyway.", 
        xp_value: 165580141, 
        rank: 3410,
    ...
    enemy_templates["夹击卫戍"] = new Enemy({
        name: "Pincer Guard",
        description: "They're still in the same series. That brother of yours who uses lasers is quite far from here…", 
        xp_value: 165580141, 
        rank: 3411,
    ...
    enemy_templates["敌意傀儡"] = new Enemy({
        name: "Hostile Puppet",
        description: "Come to think of it, doesn't the Ice Palace have a bit too much hostility? So many enemies with [Hostile] in their name!", 
        xp_value: 165580141, 
        rank: 3412,
    ...
    enemy_templates["冰兽龙龙"] = new Enemy({
        name: "Ice Beast Dragon-Dragon",
        description: "A dragon subspecies with extremely low body temperature that can unleash frost breath.", 
        xp_value: 267914296, 
        rank: 3413,
    ...
    enemy_templates["雪茸茸战士"] = new Enemy({
        name: "Snow Mushroom Warrior",
        description: "Dual-blade style! Left sword deals high damage~ right sword deals high damage!", 
        xp_value: 165580141, 
        rank: 3414,
    ...
    enemy_templates["大教内门弟子"] = new Enemy({
        name: "Major Sect Inner Disciple",
        description: "After coming from so far away, it rivals Chaos 10th turn... sorry, wrong crossover — this major sect is clearly much smaller than the scrambled-egg one…", 
        xp_value: 165580141, 
        rank: 3415,
    ...
    enemy_templates["敌意美杜莎"] = new Enemy({
        name: "Hostile Medusa",
        description: "Earth-rank cultivators turn to stone from just a glance. But for mid Sky-rank and above fighters, this kind of trick is only marginally effective.", 
        xp_value: 267914296, 
        rank: 3416,
    ...
    enemy_templates["敌意巫师"] = new Enemy({
        name: "Hostile Mage",
        description: "Stacking defenses, pass! This mage is incredibly strong yet overly cautious — not that it matters anyway.", 
        xp_value: 267914296, 
        rank: 3417,
    ...
    enemy_templates["出芽青茸战士"] = new Enemy({
        name: "Budding Cyan Mushroom Warrior",
        description: "Compared to the dual-blade fighter, this one is closer to a defense-kill strategy. Its 280 million defense makes it stand above the rest... except for those with freeze and frostbite mechanics!", 
        xp_value: 267914296, 
        rank: 3418,
        ...
        name: "Suicide Bomber Infantry",
        description: "Everyone ready~ Charge! This time they're equipped with super-powerful Absolute Zero rapid-freeze ammunition!", 
        xp_value: 267914296, 
        rank: 3419,
    ...
    enemy_templates["敌意老人"] = new Enemy({
        name: "Hostile Elder",
        description: "[Ad space for rent]: Urgently needed — a witty joke about 'milk and restrain'~", 
        xp_value: 267914296, 
        rank: 3420,
    ...
    enemy_templates["大门派先锋"] = new Enemy({
        ...
        description: "If all the vanguards get thrown into a place like this — like a sub-light-speed black hole — that sect is probably on its last legs...", 
        xp_value: 267914296, 
        rank: 3501,
    ...
    enemy_templates["水牢雪怪"] = new Enemy({
        name: "Water Prison Snow Monster",
        description: "Will it really not melt… perhaps it has an internal extreme-cold engine cycle running inside?", 
        xp_value: 267914296, 
        rank: 3502,
    ...
    enemy_templates["水牢花妖"] = new Enemy({
        name: "Water Prison Flower Demon",
        description: "Fortunately, this is a transcendent world — even without oxygen, the roots won't rot!", 
        xp_value: 267914296, 
        rank: 3503,
    ...
    enemy_templates["成熟期蛟龙"] = new Enemy({
        ...
        description: "Neither a ground dragon nor a flying dragon — because of impure bloodline, this is as far as it goes…", 
        xp_value: 267914296, 
        rank: 3504,
    ...
    enemy_templates["出芽蓝茸战士"] = new Enemy({
        name: "Budding Blue Mushroom Warrior",
        description: "Rainbow Attack (6/7). How did it suddenly gain so many abilities!", 
        xp_value: 267914296, 
        rank: 3505,
    ...
    enemy_templates["燕岗迷途强者"] = new Enemy({
        ...
        description: "迷い星のうた — but even if you got lost together, you've strayed way too far. Did you end up catching the Icicle Fish King or something…", 
        xp_value: 267914296, 
        rank: 3506,
    ...
    enemy_templates["水牢嗜血哥布林"] = new Enemy({
        ...
        description: "A seven-character name! Practically the longest-named enemy aside from Baifang [Wild Beast Forest ver.] [BOSS].<br>(PS: half-width characters count as half, so Ship Core B6 [BOSS] is also seven characters~)", 
        xp_value: 267914296, 
        rank: 3507,
    ...
    enemy_templates["识灵水藻"] = new Enemy({
        name: "Spirit-Sensing Water Algae",
        description: "Seems to have very little presence as a spirit body. In the face of high-damage swarms, spirit bodies aren't particularly special, are they?", 
        xp_value: 433494437, 
        rank: 3508,
    ...
    enemy_templates["徘徊的紫乌"] = new Enemy({
        ...
        description: "Budding Purple Mushroom? Don't think putting on a hat means nobody recognizes you.", 
        xp_value: 433494437, 
        rank: 3509,
    ...
    enemy_templates["夜巡傀儡"] = new Enemy({
        name: "Night Patrol Puppet",
        description: "Speaking of which, the Water Prison probably has no day or night… if you could see the sky, there'd be no way to keep people locked up.", 
        xp_value: 433494437, 
        rank: 3510,
    ...
    enemy_templates["水猫茸茸"] = new Enemy({
        name: "Water Cat Mushroom",
        description: "A mild halo mushroom with a relatively high ceiling. Perhaps it's what a water-dissolved mushroom looks like when fully grown?", 
        xp_value: 433494437, 
        rank: 3511,
    ...
    enemy_templates["徘徊的骸骨"] = new Enemy({
        ...
        description: "You got lost too? It seems the Icicle Fish King isn't alone~ Wait, can skeletons fish?", 
        xp_value: 433494437, 
        rank: 3512,
    ...
    enemy_templates["水牢骨角茸茸"] = new Enemy({
        name: "Water Prison Bone-Horn Mushroom",
        description: "So many different kinds of mushrooms~ Not surprising — the easiest structure to form is a circular loop, and the life it produces is mushrooms.", 
        xp_value: 433494437, 
        rank: 3513,
    ...
    enemy_templates["水牢石灵"] = new Enemy({
        ...
        description: "Will a high-HP fortified monster be a problem later? The current multiplier is already at 40%…", 
        xp_value: 433494437, 
        rank: 3514,
    ...
    enemy_templates["仙旅城强战士"] = new Enemy({
        name: "Xianlu City Elite Warrior",
        description: "Shenglv City fell, and now we're greeted by... Xianlu City? When did Acyl Chloride City join lol",
        xp_value: 433494437, 
        rank: 3515,
    ...
    enemy_templates["城主府队长"] = new Enemy({
        name: "City Lord Manor Captain",
        description: "Although the City Lord Manor standardizes white uniforms and skull helmets, after spending hundreds of years in the Water Prison, the uniforms have been soaked blue by water energy.",
        xp_value: 433494437, 
        rank: 3516,
    ...
    enemy_templates["火箭卫戍"] = new Enemy({
        name: "Rocket Guard",
        description: "Being able to keep its red uniform in a place where everything is blue is proof of its strength.",
        xp_value: 433494437, 
        rank: 3517,
    ...
    enemy_templates["小门派长老"] = new Enemy({
        ...
        description: "The elder has been away so long — is the sect doing okay… All realm, no power, like a juicy experience ball.",
        xp_value: 701408733, 
        rank: 3518,
    ...
    enemy_templates["水牢幽暗人形"] = new Enemy({
        name: "Water Prison Shadow Figure",
        description: "You might not tell here, but it has truly blended into the environment. Neko can't see the enormous damage numbers…",
        xp_value: 701408733, 
        rank: 3519,
    ...
    enemy_templates["出芽紫茸战士"] = new Enemy({
        name: "Budding Purple Mushroom Warrior",
        description: "Rainbow Attack (7/7). Have you fallen a bit behind?",
        xp_value: 701408733, 
        rank: 3520,
    ...
    enemy_templates["星月幻术师"] = new Enemy({
        ...
        description: "A powerfully skilled mage combining buff, healing, and attack forms.",
        xp_value: 701408733, 
        rank: 3521,
    ...
    enemy_templates["绿皮怪物"] = new Enemy({
        name: "Green-Skin Monster",
        description: "Come on, this is a bit lazy… do berserkers have no rights?",
        xp_value: 701408733, 
        rank: 3522,
    ...
    enemy_templates["魔化枭蝎"] = new Enemy({
        name: "Demonified Owl-Scorpion",
        description: "This magic power feels quite strong. All stats are super-enhanced, and every skill is retained.",
        xp_value: 701408733, 
        rank: 3523,
    ...
    enemy_templates["古龙幼崽"] = new Enemy({
        ...
        description: "Neko's dragon ranking: Flood Dragon << Ground Dragon < Flying Dragon << Ancient Dragon.",
        xp_value: 701408733, 
        rank: 3524,
    ...
    enemy_templates["血杀殿余孽"] = new Enemy({
        name: "Blood Kill Hall Remnant",
        description: "This organization is quite formidable… the Blood Kill Hall's secret arts and Water Prison rules happen to be a perfect match.",
        xp_value: 701408733, 
        rank: 3525,
    ...
    enemy_templates["城主府骨干"] = new Enemy({
        name: "City Lord Manor Core Member",
        description: "Literally the 'backbone.' Not sure if the City Lord Manor employees signed some kind of eternal employment contract like Qunxing's — they're still affiliated with the Manor even in this state.",
        xp_value: 1134903170, 
        rank: 3526,
    ...
    enemy_templates["奇异菇菇"] = new Enemy({
        ...
        description: "We've entered the Illusory Realm, but the fighting continues! Come to think of it, equipment from outside can actually be brought in here.",
        xp_value: 701408733, 
        rank: 3601,
    ...
    enemy_templates["幻境掌灯人"] = new Enemy({
        name: "Illusory Lantern Carrier",
        description: "Hey, there's been an update! There's light everywhere here — what use are you?",
        xp_value: 701408733, 
        rank: 3602,
    ...
    enemy_templates["蓝皮怪物"] = new Enemy({
        name: "Blue-Skin Monster",
        description: "Sitting at the same table as Green-Skin Monster! This one is just as lazily named.",
        xp_value: 701408733, 
        rank: 3603,
    ...
    enemy_templates["幻境通识者"] = new Enemy({
        name: "Illusory General Learner",
        description: "Bow tie on the chest, but looks weighed down with worry. Did it steal those clothes…?",
        xp_value: 1134903170, 
        rank: 3604,
    ...
    enemy_templates["火烈茸茸"] = new Enemy({
        ...
        description: "Somehow manages to poison in high temperatures. Just need to prevent Neko from being killed~ (if you're reading this, it failed!)",
        xp_value: 1134903170, 
        rank: 3605,
    ...
    enemy_templates["幻境翠绿行者"] = new Enemy({
        name: "Illusory Emerald Wanderer",
        description: "The Blue-Hat Wanderer is always imitated, but never surpassed — even at 400% HP.",
        xp_value: 1134903170, 
        rank: 3606,
    ...
    enemy_templates["风尘的窃贼"] = new Enemy({
        name: "Dusty Thief",
        description: "Light-chasing…? Since you can penetrate the Blazing Mushroom's defense, you're probably close to 2 billion attack and defense.",
        xp_value: 1134903170, 
        rank: 3607,
    ...
    enemy_templates["深邃级魔法师"] = new Enemy({
        name: "Deep-Level Mage",
        description: "Abandoned their main role — magic attack. Is this not a failure of a mage?! This must be the cost of deep♂dark♂fantasy.",
        xp_value: 1134903170, 
        rank: 3608,
    ...
    enemy_templates["荒野守尸人"] = new Enemy({
        name: "Wasteland Corpse Watcher",
        description: "Is the skeleton corpse-guard trying to form an MC squad? Add a Creeper, Spider, and Enderman, and you've got a band…",
        xp_value: 1134903170, 
        rank: 3609,
    ...
    enemy_templates["出芽粉茸战士"] = new Enemy({
        name: "Budding Pink Mushroom Warrior",
        description: "Rainbow Attack (8/7). Didn't someone mess up the count at the start…",
        xp_value: 1134903170, 
        rank: 3611,
    ...
    enemy_templates["凶恶的金乌"] = new Enemy({
        ...
        description: "I, Sayuki, swear here! I will never again mistake a crow for a horse like last time!",
        xp_value: 1836311903, 
        rank: 3612,
    ...
    enemy_templates["幻境血魔"] = new Enemy({
        name: "Illusory Blood Demon",
        description: "A life form separated from a single drop of blood from the Blood Demon Sea. Only has the power of an ordinary late Stage 7, but is very resilient.",
        xp_value: 1836311903, 
        rank: 3613,
    ...
    enemy_templates["窥秘商人"] = new Enemy({
        ...
        description: "Looks incredibly cunning. Has a Shadow Clan member been reincarnated here?",
        xp_value: 1836311903, 
        rank: 3614,
    ...
    enemy_templates["燕岗领独行侠"] = new Enemy({
        ...
        description: "A powerhouse who lost their way, stumbled into the Water Prison, and awakened the third layer of Domain through bloodshed... Too bad this barrier isn't a true inheritance ground.",
        xp_value: 1836311903, 
        rank: 3615,
    ...
    enemy_templates["幻境飞蛾"] = new Enemy({
        name: "Illusory Moth",
        description: "Did something go wrong here? Everything around is Stage 8 pinnacle, but you're only early Stage 8…",
        xp_value: 1134903170, 
        rank: 3616,
    ...
    enemy_templates["幻境石灵"] = new Enemy({
        name: "Illusory Stone Spirit",
        description: "If the HP multiplier keeps going up like this, these rock monsters will eventually become a problem? Inner armor's A.mul will protect everyone!",
        xp_value: 1836311903, 
        rank: 3617,
    ...
    enemy_templates["磐石蜘蛛"] = new Enemy({
        name: "Bedrock Spider",
        description: "Spiders are absolutely the strongest wild beasts. High percentage heal per turn with no upper limit.",
        xp_value: 1836311903, 
        rank: 3618,
    ...
    enemy_templates["心魔"] = new Enemy({
        name: "Heart Demon",
        description: "Has the same weakness as the BOSS version. Beat four of them and you can beat it!",
        xp_value: 2971215073, 
        rank: 3701,
    ...
    enemy_templates["燕岗辉煌佣兵"] = new Enemy({
        ...
        description: "I am the pinnacle of Azure Jade profession! Who can kill me, who dares kill me?",
        xp_value: 2971215073, 
        rank: 3702,
    ...
    enemy_templates["地宫虫将"] = new Enemy({
        name: "Underground Palace Insect General",
        description: "Stats went up five orders of magnitude from soldier to general... is [Underground Palace Insect Calamity] at the immortal divine level now?",
        xp_value: 2971215073, 
        rank: 3703,
    ...
    enemy_templates["地宫不眠者"] = new Enemy({
        name: "Underground Palace Insomniac",
        description: "So staying up all night gets you into someone's illusory demon realm! Strange knowledge has been gained.",
        xp_value: 2971215073, 
        rank: 3704,
    ...
    enemy_templates["地下焚天火"] = new Enemy({
        name: "Underground Heaven-Burning Fire",
        description: "Hits incredibly hard! But its HP is like a candle in the wind... a campfire in a typhoon? Either way, it dies easily.",
        xp_value: 2971215073, 
        rank: 3705,
    ...
    enemy_templates["燕岗城卫队长"] = new Enemy({
        ...
        description: "Were you the one who sent the Fortify unit next to the halo monster?",
        xp_value: 2971215073, 
        rank: 3706,
    ...
    enemy_templates["秘境荧光帕芙"] = new Enemy({
        name: "Secret Realm Glowing Puff",
        description: "Recently, everyone's been chasing the shiny variant — is this it?",
        xp_value: 2971215073, 
        rank: 3707,
    ...
    enemy_templates["秘境闪耀精灵"] = new Enemy({
        name: "Secret Realm Shining Sprite",
        description: "Even brighter! Bewildering illusion… is this really the first enemy here with that kind of ability?",
        xp_value: 2971215073, 
        rank: 3708,
    ...
    enemy_templates["喵咕啦"] = new Enemy({
        name: "Nyagoola",
        description: "How does this creature mimic big sis's appearance… it can simulate clothing, but what about skin?",
        xp_value: 2971215073, 
        rank: 3709,
    ...
    enemy_templates["残雪灵阵"] = new Enemy({
        name: "Remnant Snow Spirit Array",
        description: "Legend has it, in a timeline where witch power was everywhere, many Remnant Snow Spirit Arrays were released into the Underground Palace. Fortunately, nothing like that happened here.",
        xp_value: 2971215073, 
        rank: 3710,
    ...
    enemy_templates["晓雪魅蝠"] = new Enemy({
        name: "Xiaoxue Enchanting Bat",
        description: "Adding 'Xiao' before the name really does sound stronger! A wretched bat that gains more HP the more you hit it…",
        xp_value: 2971215073, 
        rank: 3711,
    ...
    enemy_templates["威武星骑士"] = new Enemy({
        ...
        description: "Fortunately, the Blue-Hat Wanderer from Boundary Lake didn't show up here wearing an even bigger hat. Otherwise it'd probably have trillions of HP.",
        xp_value: 4807526976, 
        rank: 3712,
    ...
    enemy_templates["圣荒城头目"] = new Enemy({
        name: "Shenghang City Boss",
        description: "The Illusory Realm has replicated the weakness of the corresponding city's inhabitants! The method to go through unscathed is now plain to see.",
        xp_value: 4807526976, 
        rank: 3713,
    ...
    enemy_templates["兰陵城头目"] = new Enemy({
        ...
        description: "Same with this one! Although the Ice Palace Illusion is deep within Yangang Territory, the spirits in the illusion are manifestations of fear.",
        xp_value: 4807526976, 
        rank: 3714,
    ...
    enemy_templates["战场不朽骸骨"] = new Enemy({
        name: "Battlefield Undying Skeleton",
        description: "Even the skull has turned black. The halo... is even slightly stronger?",
        xp_value: 4807526976, 
        rank: 3715,
    ...
    enemy_templates["血腥追风者"] = new Enemy({
        ...
        description: "The [Ruin Wind-Chaser]'s conceptual disturbance has extended into the Illusory Realm! After all, light-chasing as a minion ability is just too overpowered...",
        xp_value: 4807526976, 
        rank: 3716,
    ...
    enemy_templates["黄桃重工B9"] = new Enemy({
        name: "Huangtao Heavy Industries B9",
        description: "Heh, you've grown. Drinking Shield ratio is ten times higher too. But — the basic attack ratio has gone up way more than tenfold!",
        xp_value: 4807526976, 
        rank: 3717,
    ...
    enemy_templates["不可能三角B9"] = new Enemy({
        ...
        description: "Is it possible... just maybe... that it has a bunch of pre-battle self-buffs we just don't know about?",
        xp_value: 4807526976, 
        rank: 3718,
    ...
    enemy_templates["极寒之锋B9"] = new Enemy({
        name: "Extreme Cold Edge B9",
        description: "I'll never forget the terror of being dominated by Blood Edge B1. Also, HP cap... Restraint 3.0 has arrived?!",
        xp_value: 4807526976, 
        rank: 3719,
    ...
    enemy_templates["金色血眼B9"] = new Enemy({
        ...
        description: "Simple mechanics, extreme... talk to my Crescent Moon!",
        xp_value: 4807526976, 
        rank: 3720,
    ...
    enemy_templates["恐怖机人B9"] = new Enemy({
        name: "Terror Mech B9",
        description: "I get the theory, but why aren't you 32x32 pixels? So the Dimensional Gate is actually a teleporter!",
        xp_value: 4807526976, 
        rank: 3721,
    ...
    enemy_templates["冈崎喵妖"] = new Enemy({
        name: "Okazaki Neko-Demon",
        description: "Terrifying burst attack... where did your agility go! Do you really think you can hit anyone when you're this fragile?",
        xp_value: 7778742049, 
        rank: 3722,
    ...
    enemy_templates["血洛大陆骨干"] = new Enemy({
        name: "Xuelo Continent Core Member",
        description: "The backbone has gone from bones to a cool mecha! No wonder the Yangang City Lord's Manor never seemed that strong.",
        xp_value: 7778742049, 
        rank: 3723,
    ...
    enemy_templates["扭曲毒虫"] = new Enemy({
        name: "Twisted Poison Worm",
        description: "Its methods of buffing itself and debuffing enemies are incredibly refined. When will Neko be able to learn these?",
        xp_value: 7778742049, 
        rank: 3724,
    ...
    enemy_templates["狠咕兽"] = new Enemy({
        name: "Fierce Goo Beast",
        description: "The game's been updated… stacking raw stats without pure quality doesn't work anymore. Talk to my basic attack multiplier!",
        xp_value: 7778742049, 
        rank: 3725,
    ...
    enemy_templates["超量凶悍树妖"] = new Enemy({
        name: "Overlimit Vicious Tree Demon",
        description: "Generally speaking, base stats that exceed normal peak by 2x are called [Overlimit/Boundary Break], and awarded the rank of [Minion/Human Class]...<br>But for clarity, NekoRPG uses plus signs for all of them!",
        xp_value: 7778742049, 
        rank: 3726,
    ...
    enemy_templates["暗杀飞蛾"] = new Enemy({
        name: "Assassination Moth",
        description: "Unfortunately, assassination doesn't work here — if you're in the combat frame, you're a valid target!",
        xp_value: 7778742049, 
        rank: 3727,
    ...
    enemy_templates["古龙小兽"] = new Enemy({
        name: "Ancient Dragon Beast",
        description: "The [Ancient Dragon] is the strongest dragon clan here! Every one of them has the bloodline of an adult <span class='realm_cloudy'>Cloudy Sky-Rank Pinnacle</span>. Though this one probably won't grow up.",
        xp_value: 7778742049, 
        rank: 3728,
    ...
    enemy_templates["巨人强豪"] = new Enemy({
        ...
        description: "Remember the [Giant Vanguard] from the Infinite Secret Realm… if the realm had no cap, at floor 891,880 it would have the attack power of this one.",
        xp_value: 7778742049, 
        rank: 3729,
    ...
    enemy_templates["血洛流浪剑客"] = new Enemy({
        ...
        description: "Another wanderer who drifted in! Really want to learn the Celestial Sword... basic attack multiplier is there, but the attack multiplier zone is sorely lacking.",
        xp_value: 7778742049, 
        rank: 3730,
    ...
    enemy_templates["大门派精英"] = new Enemy({
        ...
        description: "Has deep and profound reserves — could break through anytime. But the future of becoming one of the [Heart Spirits] is just too bleak…",
...
(function(){
    ...
    enemy_templates["探险者的怨恨[BOSS]"] = new Enemy({
        name: "Explorer's Resentment [BOSS]",
        description: "Despite having Time-Seal and 200% HP, zero defense can't withstand the basic attack multiplier~",
        xp_value: 102334155, 
        rank: 3397,
    ...
    enemy_templates["敌意猎兵[BOSS]"] = new Enemy({
        ...
        description: "Not particularly strong on its own… but there are six of them mobbing you.",
        xp_value: 102334155, 
        rank: 3398,
    ...
    enemy_templates["敌意女巫[BOSS]"] = new Enemy({
        ...
        description: "Hiding behind a crowd of hunters to ambush you! How despicable…",
        xp_value: 165580141, 
        rank: 3399,
    ...
    enemy_templates["敌意老人[BOSS]"] = new Enemy({
        ...
        description: "Quite durable, but durability is all it has left.",
        xp_value: 267914296, 
        rank: 3499,
    ...
    enemy_templates["竺虎[BOSS]"] = new Enemy({
        name: "Zhu Hu [BOSS]",
        description: "Considered genuinely powerful among peers, but trying to overcome Neko by force — isn't that a mistake?",
        xp_value: 267914296, 
        rank: 3595,
    ...
    enemy_templates["莫尔[BOSS]"] = new Enemy({
        name: "Mor [BOSS]",
        description: "A good person in the Water Prison. How moving…",
        xp_value: 433494437, 
        rank: 3596,
    ...
    enemy_templates["秋兴[BOSS]"] = new Enemy({
        name: "Qiu Xing [BOSS]",
        description: "[Fallen Leaf Blade] — a top-ranked powerhouse. Currently ranked third — by the time you see this message, that's changed.",
        xp_value: 701408733, 
        rank: 3597,
    ...
    enemy_templates["蓝柒[放水 ver.][BOSS]"] = new Enemy({
        name: "Lan Qi [Easy Mode ver.] [BOSS]",
        description: "The publisher of the power ranking, possessing overwhelming strength. Though here only one of her three domains is in use…",
        xp_value: 701408733, 
        rank: 3598,
        image: "image/boss/B3504.png",
        realm: "<span class=realm_sky><b>Sky Rank: Stage 6 +++</b></span>",//true power: Sky Rank: Stage 6 [IV]. (3+ pluses use Roman numerals)
        size: "small",
        spec: [0],
        tags: [],
    ...
    enemy_templates["蓝柒[BOSS]"] = new Enemy({
        name: "Lan Qi [BOSS]",
        description: "The publisher of the power ranking, possessing overwhelming strength. With all three domains unleashed, she is terrifyingly powerful, even surpassing the 3+ realm…",
        xp_value: 1134903170, 
        rank: 3599,
        image: "image/boss/B3504.png",
    ...
    enemy_templates["怪物手册[BOSS]"] = new Enemy({
        name: "Monster Manual [BOSS]",
        description: "Why did the monster manual come to life! Also, don't you think Suppress is even more of a burden than Restraint…",
        xp_value: 2971215073, 
        rank: 3697,
    ...
    enemy_templates["心魔木偶[SP]"] = new Enemy({
        name: "Heart Demon Puppet [SP]",
        description: "A puppet infused with power by a higher-dimensional entity. After testing Suppress·Fake, it's time to clock off!",
        xp_value: 4807526976, 
        rank: 3698,
    ...
    enemy_templates["心魔[BOSS]"] = new Enemy({
        name: "Heart Demon [BOSS]",
        description: "I preserved some resonance so you can tell you're fighting a Heart Demon. But it'll still be bullied by Restraint Comprehension!",
        xp_value: 2971215073, 
        rank: 3699,
    ...
    enemy_templates["喵咕啦[BOSS]"] = new Enemy({
        name: "Nyagoola [BOSS]",
        description: "The colors really are very similar to big sis's clothes… now isn't the time to be thinking about that!",
        xp_value: 4807526976, 
        rank: 3791,
    ...
    enemy_templates["不可能三角B9[BOSS]"] = new Enemy({
        ...
        description: "A pure stat monster. I'd guess if you've made it this far, you're not very afraid of it.",
        xp_value: 4807526976, 
        rank: 3792,
    ...
    enemy_templates["末世天骄[BOSS]"] = new Enemy({
        name: "End-Times Prodigy [BOSS]",
        description: "A fragment of soul from a genius of the End-Times Secret Realm. After the long passage of time, 99.9999% of their power has faded, leaving only <span class=realm_sky><b>Sky-Rank Pinnacle ++</b></span> energy…",
        xp_value: 7778742049, 
        rank: 3793,
        image: "image/boss/B3703.png",
        realm: "<span class=realm_cloudy><del><b>Cloudy Sky Rank: Pinnacle [XII]</b><del>Cloudy Sky Rank: Stage 1 --</span>",
        size: "small",
        spec: [51,15,34],
        tags: [],
    ...
    enemy_templates["狠咕兽[BOSS]"] = new Enemy({
        name: "Fierce Goo Beast [BOSS]",
        description: "Thank goodness it's not the big gem version of the Special Goo Beast. Another stat monster — plain and ordinary, right?",
        xp_value: 7778742049, 
        rank: 3794,
    ...
    enemy_templates["心魔之主[BOSS]"] = new Enemy({
        name: "Heart Demon Lord [BOSS]",
        description: "Normal Cloudy Sky Stage 1 corresponds to Sky-Rank Pinnacle +++. Clearly, this Heart Demon did not break through normally… the realm is unstable, even on the verge of collapse.",
        xp_value: 7778742049, 
        rank: 3795,
        image: "image/boss/B3705.png",
        realm: "<span class=realm_cloudy><b>Cloudy Sky Rank: Stage 1 -</b></span>",
        size: "small",
        spec: [36,52],
        tags: [],
    ...
    enemy_templates["心之灵·禁锢[BOSS]"] = new Enemy({
        name: "Heart Spirit · Shackled [BOSS]",
        description: "A Cloudy Sky-rank powerhouse selected by Zuoa as a [vessel].",
        xp_value: 12586269025, 
        rank: 3796,
    ...
    enemy_templates["心之灵·滋生[BOSS]"] = new Enemy({
        name: "Heart Spirit · Proliferating [BOSS]",
        description: "A Cloudy Sky-rank powerhouse selected by Zuoa as a [vessel].",
        xp_value: 12586269025, 
        rank: 3797,
    ...
    enemy_templates["心之灵·暴走[BOSS]"] = new Enemy({
        name: "Heart Spirit · Berserk [BOSS]",
        description: "A Cloudy Sky-rank powerhouse selected by Zuoa as a [vessel].",
        xp_value: 12586269025, 
        rank: 3798,
    ...
    enemy_templates["左阿(垂死)[BOSS]"] = new Enemy({
        name: "Zuoa (Dying) [BOSS]",
        description: "The last remnant of a soul, with only 0.01% of its power remaining after being sealed. Not even the thousandfold calculation foresaw this step… Oh well. Only Cloudy Sky Stage 5 XP. It's too weak now.",
        xp_value: 591286729879, 
        rank: 3799,
        image: "image/boss/B3709.png",
        realm: "<span class=realm_realm><b>Domain Rank: Stage 1 [-18]</b></span>",
        size: "small",
        spec: [34,17],
        tags: [],
    ...
    enemy_templates["左阿[BOSS]"] = new Enemy({
        name: "Zuoa [BOSS]",
        description: "How are you reading this? You cheated, didn't you.",
        xp_value: 591286729879, 
        rank: 3799.9,
        image: "image/boss/B3709.png",
        realm: "<span class=realm_realm><b>Domain Rank: Stage 1 [-2]</b></span>",
        size: "small",
        spec: [34,17],
        tags: [],
    ...
    enemy_templates["纳布[BOSS]"] = new Enemy({
        name: "Nabu [BOSS]",
        description: "The persimmon has always been like this... old thing, your era is over!",
        xp_value: 12586269025, 
        rank: 4197,
        image: "image/boss/B4101.png",
        realm: "<span class=realm_realm><b>Cloudy Sky Rank: Stage 1</b></span>",
        size: "small",
        spec: [10],
        tags: [],
